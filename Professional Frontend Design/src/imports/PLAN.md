...
1. **Contacto Directo:** Botón de consulta/pedido rápido que abre chat directo con la Administradora (Alessandra Rostirolla).
...
- **WhatsApp (Administradora):** +54 9 11 5691-6710
- **Enlace directo de WhatsApp:** https://wa.me/5491156916710

**Zona de entrega:** Ituzaingó, Zona Oeste, Buenos Aires, Argentina.
...
## 📸 Imágenes
- Actualmente: placeholders SVG en `assets/img/`.
- Pendiente: generar fotos reales (huevos y codornices) y el diseño final con la IA de Figma, luego reemplazar en `assets/img/`.

---

## 🛠️ Tech Stack
- **Frontend:** HTML5 + CSS3 vanilla + JavaScript vanilla (sitio estático, listo para Netlify/Vercel).
- **Enlace a Figma:** diseño final y fotos se recreen desde la IA de Figma (Make Design) cuando estén disponibles. Acceso a Figma vía el MCP `figma` configurado en opencode.
- **Integración de Pago:** Mercado Pago SDK / Checkout Pro (vía Preferencias).
- **Notificaciones/Redirección:** WhatsApp Business API (URL schemes `https://wa.me/...`).
