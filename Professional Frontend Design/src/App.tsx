...
function buildMsg(cart: Record<string, number>) {
  ...
  return encodeURIComponent(
    [
      "¡Hola Alessandra! Quiero hacer el siguiente pedido desde la web:",
      "",
      ...lines,
      "",
...
export default function App() {
  ...
  return (
    <div style={{ color: "#2c1a0e", minHeight: "100vh" }}>
            ...
            <div style={{ backgroundColor: "rgba(248,235,219,0.07)", borderRadius: "2rem", padding: "40px", border: "1px solid rgba(248,235,219,0.1)" }}>
              <div style={{ marginBottom: "32px" }}>
                ...
                <p style={{ fontSize: "0.9rem", color: "#e8d5bc", opacity: 0.65, lineHeight: 1.65 }}>
                  El pedido se envía como mensaje pre-armado a la Administradora. Después acordamos el pago y coordinamos la entrega según tu zona.
                </p>
              </div>
              <a
      ...
      <section id="contacto" style={{ padding: "96px 0" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }}>
            <div>
              {[
                { label: "Administradora", value: "Alessandra Rostirolla", href: undefined },
